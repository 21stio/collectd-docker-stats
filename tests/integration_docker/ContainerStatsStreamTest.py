...
class ContainerStatsStreamTest(unittest.TestCase):
        ...
        def test_get_stats(self):
            ...
            container_id = self.cls.dockerFormatter.get_container_id(containers[0])

            stats = self.cls.containerStatsStreamPool.get_ContainerStatsStream(container_id).get_stats()
